...
<table class="table table-hovered">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><img src="<?php echo e(IMAGE_URL); ?><?php echo e('/'. $item->products->images); ?>" alt="" style="width:80px"> </td>
            <td><?php echo e($item->products->name); ?></td>
            <td> <?php echo e($item->date); ?></td>
            
            <td>
            <?php if($item->status==1): ?>Show 
            <?php else: ?> Hidden
            <?php endif; ?>
            </td>
           
            <td><a href="<?php echo e(BASE_URL); ?>admin/comment/detail?id=<?php echo e($item->id); ?>" class="btn btn-success">Chi tiết</a></td>
        </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH O:\xampp\htdocs\PHP2\Assment\app\views\backend/comment/index.blade.php ENDPATH**/ ?>