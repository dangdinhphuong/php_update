					...
					<form action="<?php echo e(BASE_URL.'post_login_client'); ?>/singin" method="post">
						<div class="form sign-in">
							...
							<p>
								...
								<a href="<?php echo e(BASE_URL.'singup_client'); ?>">
								<b onclick="toggle()" class="pointer">
							...
							<p>
							<span>
								<a href="<?php echo e(BASE_URL.'login_admin'); ?>">
								admin login
								</a>
								</span>	
							</p>
...
</html><?php /**PATH O:\xampp\htdocs\PHP2\Assment\app\views\frontend/login/singin.blade.php ENDPATH**/ ?>