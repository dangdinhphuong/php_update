...
<script>
    setTimeout(function() { //hiển thị alert sau 2 giây
        $('.alert-warning').addClass('show'); // thêm class show vào class alert-warning
    }, 1000);
</script>
<script>
    // alert("thanh cong");
    $(".woocommerce-ordering>.aaa> ").on("click", function(e) {
        e.preventDefault();
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH O:\xampp\htdocs\PHP2\Assment\app\views\frontend/home/index.blade.php ENDPATH**/ ?>